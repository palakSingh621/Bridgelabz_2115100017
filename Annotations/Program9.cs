...
namespace Annotaions_Assisgnment1
{
    ...
    // Custom Attribute for Max Length Validation
    ...
    // User class with MaxLength validation
    class User
    {
        [MaxLength(10)]
        ...
        public User(string username)
        {
            ...
            {
                throw new ArgumentException("Username exceeds maximum length of 10 characters.");
            }
            Username = username;
        }
    }
